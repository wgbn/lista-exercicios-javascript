    ...
    printTarefas: function(){
        ...
        var Lista = React.createClass({
            ...
            render: function () {
                ...
                return (
                    <div className="lista">{asTarefas}</div>
                );
            }
        });
        ...
        var ItemLista = React.createClass({
                ...
                render: function () {
                    ...
                    return (
                        <div className="item" id={"tarefa-"+this.props.chave} data-id={this.props.chave} onClick={meuApp.marcarTarefa}>
