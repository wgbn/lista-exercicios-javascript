    ...
    printTarefas: function(){
        ...
        var Lista = React.createClass({displayName: "Lista",
            getInitialState: function() {
                return meuApp._lista;
            },
            render: function () {
                var productNodes = this.props.data.map(function (_val, _key) {
        ...
        var ItemLista = React.createClass({displayName: "ItemLista",
                ...
                render: function () {
                    ...
                    return (
                        React.createElement("div", {class: "item", id: "tarefa-{this.props.key}", "data-id": "{this.props.key}"},
                            React.createElement("div", {class: "status {_status}", "data-id": "{this.props.key}"}, " "),
                            React.createElement("div", {class: "texto ", "data-id": "{this.props.key}"}, this.props.tarefa),
                            React.createElement("div", {class: "del", "data-id": "{this.props.key}"}, "X")
                        )
                    );
                }
        });
