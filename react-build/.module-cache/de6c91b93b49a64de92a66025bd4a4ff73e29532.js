    ...
    printTarefas: function(){
        ...
        var ItemLista = React.createClass({displayName: "ItemLista",
                ...
                render: function () {
                    ...
                    return (
                        React.createElement("div", {className: "item tarefa-"+this.props.chave, "data-id": this.props.chave},
                            React.createElement("div", {className: "status "+_status, "data-id": this.props.chave}, " ", this.props.chave),
