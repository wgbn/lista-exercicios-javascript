                ...
                render: function () {
                    ...
                    return (
                        React.createElement("div", {class: "item", id: "tarefa-{this.props.key}", "data-id": "{this.props.key}"},
                            React.createElement("div", {class: "status fundo-vermelho", "data-id": "0"}, " "),
                            React.createElement("div", {class: "texto ", "data-id": "0"}, "porra"),
                            React.createElement("div", {class: "del", "data-id": "0"}, "X")
                        )
                    );
                }
        });
