    ...
    printTarefas: function(){
        ...
        var ItemLista = React.createClass({displayName: "ItemLista",
                ...
                render: function () {
                    ...
                    return (
                        React.createElement("div", {className: "item", id: "tarefa-"+this.props.key, "data-id": this.props.key},
                            React.createElement("div", {className: "status {_status}", "data-id": this.props.key}, " "),
