        ...
        var Lista = React.createClass({displayName: "Lista",
            ...
            render: function () {
                var productNodes = this.props.data.map(function (product) {
                    return React.createElement(ItemLista, {ammount: product.ammount, checked: product.checked}, product.name);
                });
                ...
                render: function () {
                    ...
                    return (
                        React.createElement("div", {class: "item", id: "tarefa-{this.props.key}", "data-id": "{this.props.key}"},
                            React.createElement("div", {class: "status fundo-vermelho", "data-id": "{this.props.key}"}, " "),
