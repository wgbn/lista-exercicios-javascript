var meuApp = {
    ...
    printTarefas: function(){
        ...
        var Lista = React.createClass({displayName: "Lista",
            ...
            render: function () {
                var asTarefas = this.state.lista.map(function (_val, _key) { console.log(_key);
                    return React.createElement(ItemLista, {key: _key, tarefa: _val.tarefa, status: _val.status});
                });
        ...
        var ItemLista = React.createClass({displayName: "ItemLista",
                ...
                render: function () {
                    ...
                    return (
                        React.createElement("div", {className: "item tarefa-"+this.props.key, "data-id": this.props.key},
                            React.createElement("div", {className: "status "+_status, "data-id": this.props.key}, " ", this.props.key),
                            React.createElement("div", {className: "texto ", "data-id": this.props.key}, this.props.tarefa),
                            React.createElement("div", {className: "del", "data-id": this.props.key}, "X")
                        )
                    );
                }
        });
