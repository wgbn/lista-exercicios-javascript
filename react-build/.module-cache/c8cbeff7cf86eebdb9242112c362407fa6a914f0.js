var meuApp = {
    ...
    marcarTarefa: function(e){
        ...
        if (e.target.className == 'del'){
            ...
            this.children[1].setAttribute('class', 'texto'+(meuApp._lista[e.target.dataset.id].status ? ' concluido':''));

            // altera a cor do status da tarefa
            this.children[0].setAttribute('class', 'status '+(meuApp._lista[e.target.dataset.id].status ? 'fundo-verde':'fundo-vermelho'));
        }
